...
class SpotifyBrowse(SpotifyBase):
    def featured_playlists(self, country: str = None, locale: str = None, timestamp: str = None,
        ...
        Parameters:
            ...
            - locale - desired language, consisting of a lowercase ISO 639 language code
                        and an uppercase ISO 3166-1 alpha-2 country code, joined by an underscore.
            - timestamp - timestamp in ISO 8601 format: yyyy-MM-ddTHH:mm:ss. Used to specify the user's local time
    ...
    def category(self, category_id: str, country: str = None, locale: str = None):
        ...
        Parameters:
            ...
            - locale - The desired language, consisting of an ISO 639 language code
                        and an ISO 3166-1 alpha-2 country code, joined by an underscore.
        """
        return self._get('browse/categories/' + category_id, country=country, locale=locale)

    def category_playlists(self, category_id: str = None, country: str = None, limit: int = 20, offset: int = 0):
        """
        ...
        Parameters:
            ...
            - offset - the index of the first item to return
        """
        return self._get('browse/categories/{}/playlists'.format(category_id),
                         country=country, limit=limit, offset=offset)

    def recommendations(self, artist_ids: list = None, genres: list = None, track_ids: list = None,
                        limit: int = 20, market: str = 'from_token', **kwargs):
        """
        ...
        Parameters:
            ...
            - kwargs - min/max/target_<attribute> - For the tuneable track attributes listed in the documentation,
