...
:class:`Credentials <spotipy.auth.expiring.Credentials>`
but returns tokens that refresh themselves automatically.

Expiring credentials
--------------------
.. autoclass:: spotipy.auth.expiring.Credentials
   :members:

.. autoclass:: spotipy.auth.expiring.Token
   :members:

Refreshing credentials
----------------------
.. autoclass:: spotipy.auth.refreshing.RefreshingCredentials
   :members:

.. autoclass:: spotipy.auth.refreshing.RefreshingToken
   :members:
"""

from spotipy.auth.expiring import Credentials
from spotipy.auth.refreshing import RefreshingCredentials
