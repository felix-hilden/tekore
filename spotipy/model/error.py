...
class PlayerErrorReason(Enum):
    NO_PREV_TRACK = 'The commnad requires a previous track, but there is none in the context.'
    ...
    ALREADY_PLAYING = """The track should not be restarted if the same track and context is already playing, \
